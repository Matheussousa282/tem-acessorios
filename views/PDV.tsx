...
const PDV: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-slate-50 dark:bg-background-dark overflow-hidden font-display relative">
      ...
      {/* MODAIS: Edição Item, Desconto Global e Checkout Restaurados */}
      {editingItem && (
                 ...
                 <div className="space-y-4 min-h-[320px]">
                    {activeCustomerTab === 'basic' ? (
                       <div className="space-y-4">
                          ...
                          <input placeholder="CPF / CNPJ" value={customerForm.cpfCnpj} onChange={e => setCustomerForm({...customerForm, cpfCnpj: e.target.value})} className="w-full h-16 bg-[#1a2433] border-none rounded-2xl px-6 text-sm font-black text-white uppercase focus:ring-2 focus:ring-primary outline-none" />
                       </div>
                    ) : (
                       <div className="space-y-4">
                          <input placeholder="CEP" value={customerForm.zipCode} onChange={e => setCustomerForm({...customerForm, zipCode: e.target.value})} className="w-full h-16 bg-[#1a2433] border-none rounded-2xl px-6 text-sm font-black text-white uppercase focus:ring-2 focus:ring-primary outline-none" />
      ...
      <style>{`
        ...
        @media print {
          ...
          aside, header, main, .print\\:hidden, div[class*="fixed"], div[class*="backdrop-blur"] { display: none !important; }
